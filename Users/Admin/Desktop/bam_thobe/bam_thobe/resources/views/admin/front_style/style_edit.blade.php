...
<div class="basic-form-area mg-b-15">
  <div class="container-fluid sparkline13-list">
    <div class="page-header">
      <h2 class="main-content-title">Edit Front Style</h2>
      <ol class="breadcrumb">
        ...
        <div class="card">
          <div class="cardarea">
            <div class="basic-login-form-ad">
              ...
              <form method="POST" action="{{url('thobe-front-style-update')}}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                {{csrf_field()}}
	...
	@foreach($thobe as $row)
                      ...
                      <option value="{{ $row->id }}" <?php echo $style->thobe_style_id==$row->id ? 'selected=" "':'';?>>{{ $row->name }}</option>
	...
	@endforeach
                ...
                <div class="form-group-inner row">
                  <label class="col-md-2 col-sm-3 col-xs-12"> Style Name</label>
                  <div class="col-md-10 col-sm-9 col-xs-12">
                    <input type="hidden" class="form-control" name="id" value="{{$style->id}}"/>
                    <input type="text" class="form-control" name="style" value="{{$style->style}}"/>
                    @if($errors->has('style'))
                ...
                <div class="form-group-inner row">
                  ...
                  <div class="col-md-10 col-sm-9 col-xs-12">
                    <input type="text" class="form-control" name="price" value="{{$style->price}}"/>
                    @if($errors->has('price'))
                ...
                <div class="form-group-inner row">
                  ...
                  <div class="col-md-10 col-sm-9 col-xs-12">
                <textarea name="description" class="form-control" id="" cols="30" rows="10">{{$style->description}}</textarea>
