...
<div class="basic-form-area mg-b-15">
  <div class="container-fluid sparkline13-list">
    <div class="page-header">
      <h2 class="main-content-title">Add Pocket</h2>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page"> Add Pocket</li>
      </ol>
    </div>
    ...
    <div class="card">
      <div class="cardarea">
        <div class="basic-login-form-ad">
            ...
            <form method="POST" action="{{url('thobe-add-pocket')}}" class="form-horizontal form-label-left" enctype="multipart/form-data">
              {{csrf_field()}}
              ...
              <div class="form-group-inner row">
                ...
                <div class="col-md-10 col-sm-9 col-xs-12">
                  <input type="text" class="form-control" name="pocket" value="{{old('pocket')}}" />
                  @if($errors->has('pocket')) {{$errors->first('pocket')}} @endif </div>
              </div>
