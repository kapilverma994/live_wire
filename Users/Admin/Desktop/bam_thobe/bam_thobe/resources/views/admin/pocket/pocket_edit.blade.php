...
<div class="basic-form-area mg-b-15">
  <div class="container-fluid sparkline13-list">
    <div class="page-header">
      <h2 class="main-content-title">Edit Pocket</h2>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">Edit pocket</li>
      </ol>
    </div>
    <div class="row">
        ...
        <div class="card">
          <div class="cardarea">
            <div class="basic-login-form-ad">
              ...
              <form method="POST" action="{{url('thobe-pocket-update')}}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                {{csrf_field()}}
	...
	@foreach($thobe as $row)
                      ...
                      <option value="{{ $row->id }}" <?php echo $pocket->thobe_style_id==$row->id ? 'selected=" "':'';?>>{{ $row->name }}</option>
	...
	@endforeach
                ...
                <div class="form-group-inner row">
                  <label class="col-md-2 col-sm-3 col-xs-12"> Pocket</label>
                  <div class="col-md-10 col-sm-9 col-xs-12">
                    <input type="hidden" class="form-control" name="id" value="{{$pocket->id}}"/>
                    <input type="text" class="form-control" name="pocket" value="{{$pocket->pocket}}"/>
                    @if($errors->has('pocket'))
                ...
                <div class="form-group-inner row">
                  ...
                  <div class="col-md-10 col-sm-9 col-xs-12">
                    <input type="text" class="form-control" name="price" value="{{$pocket->price}}"/>
                    @if($errors->has('price'))
                ...
                <div class="form-group-inner row">
                    ...
                    <div class="col-md-10 col-sm-9 col-xs-12">
                   <textarea name="description" class="form-control" id="" cols="30" rows="10">{{$pocket->description}}</textarea>
