...
<div class="basic-form-area mg-b-15">
  ...
  <div class="container-fluid sparkline13-list">
    <div class="page-header">
      <h2 class="main-content-title">Add Slider</h2>
      <ol class="breadcrumb">
              ...
              <div class="row">
                <div class="col-xs-12">
                  <div class="all-form-element-inner">
                    <form method="POST" action="{{url('add_slider')}}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                      {{csrf_field()}}
                      ...
                      <div class="form-group-inner row">
                        ...
                        <div class="col-md-10 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name="short_title" value="{{old('short_title')}}"/>
